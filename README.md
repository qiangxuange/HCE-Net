...
All images adopted in this study are sourced from publicly accessible open datasets and utilized solely for methodological validation and academic research. All visual materials comply with the CC BY 4.0 Creative Commons Attribution License, which permits unrestricted reproduction, distribution, adaptation and commercial application, thereby fully satisfying journal copyright specifications. All data required to reproduce the experimental results are provided. The minimal dataset and code repository can be accessed at https://github.com/qiangxuange/HCE-net/. Consistent with the above, all datasets used in this study are publicly available.
#
#
